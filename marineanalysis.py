...
bounty_por_tripulacao = (
    df.groupby("tripulacao")["bounty"]
      .sum()
      .reset_index()
      .sort_values(by="bounty", ascending=False)
)

bounty_medio = df["bounty"].mean()

capitaes_perigosos = (
    df.groupby("capitao")["bounty"]
      .sum()
      .reset_index()
      .sort_values(by="bounty", ascending=False)
)
...
top_piratas = (
    df.sort_values(by="bounty", ascending=False)
      .head(3)[["pirata", "bounty"]]
)
