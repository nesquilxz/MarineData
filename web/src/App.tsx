 ...
 * SPDX-License-Identifier: Apache-2.0
 ...
 developed by Pedro Henriques! Please do not copy the code without authorization
 */
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-6">
      <div className="flex items-center gap-8 bg-white/70 backdrop-blur-md border border-gray-200/80 rounded-full px-5 py-2.5 shadow-sm transition-all duration-300">
        <div className="flex items-center gap-3">
          ...
          />
          <span className="font-bold text-[#001C5E] tracking-tight">
            MARINE DATA
          </span>
        </div>
...
const BountyPoster = ({
  ...
  return (
    <div
      className={`wanted-border bg-[#F5E6CA] p-4 ${isLarge ? "w-64" : "w-48"} rotate-1 hover:rotate-0 transition-transform duration-300 shadow-2xl relative overflow-hidden group`}
    >
      ...
      <div className="text-center font-serif font-black text-gray-800 uppercase tracking-[0.2em] mb-2 text-xl italic select-none">
        Wanted
      </div>
      ...
      <div className="text-center">
        <div className="text-xl font-black text-gray-900 tracking-tighter leading-tight uppercase mb-1 font-serif">
          {pirate.pirata}
        </div>
        <div className="bg-gray-900/5 py-1 px-2 rounded-md">
          ...
          <div className="text-lg font-black text-gray-800 tracking-tight leading-none">
            {formatBounty(pirate.bounty)}
          </div>
        </div>
      </div>
...
const WantedPosterSkeleton = ({
  ...
  return (
    ...
    >
      <div className="text-center font-serif font-black text-[#0039B9]/20 uppercase tracking-[0.1em] mb-1.5 text-xs italic">
        Wanted
      </div>
      ...
      <div className="text-center space-y-1.5">
        ...
        <div className="bg-[#0039B9]/5 py-1 px-2 rounded-md space-y-0.5">
          <div className="text-[6px] font-black text-gray-400 uppercase tracking-widest">
            Global Scan
          </div>
          <div className="text-[9px] font-black text-[#0039B9] font-mono">
            {pirate ? (
              ...
              <div className="h-3 bg-[#0039B9]/10 rounded-full w-2/3 mx-auto" />
            )}
          </div>
        </div>
      </div>
      ...
      <div className="mt-2 pt-1.5 border-t border-gray-100 flex justify-between items-center px-0.5">
        ...
        <div className="text-[6px] font-black text-gray-300 uppercase tracking-tighter">
          Marine Intel
        </div>
      </div>
    </div>
...
const SectionHeader = ({
  ...
  <div
    id={id}
    className="max-w-7xl mx-auto px-6 mb-16 text-center lg:text-left"
  >
...
const IntelligenceDashboard = () => {
  ...
  const topPirates = useMemo(() => {
    if (showOnlyAliveTop3) {
      return allPirates
        .filter(
          (p) => p.status_historia === "Vivo" || p.status_historia === "Viva",
        )
  ...
  const [selectedPirate, setSelectedPirate] = useState<PirateRecord | null>(
    null,
  );
  const [expandedCommander, setExpandedCommander] = useState<string | null>(
    null,
  );
  ...
  const filteredPirates = useMemo(() => {
    return allPirates.filter((p) => {
      ...
      const matchesStatus =
        statusFilter === "All" ||
        (statusFilter === "Vivo" &&
          (p.status_historia === "Vivo" || p.status_historia === "Viva")) ||
        (statusFilter === "Falecido" && p.status_historia === "Falecido") ||
        (statusFilter === "Desaparecido" &&
          (p.status_historia.includes("Desconhecido") ||
            p.status_historia.includes("Desaparecido")));
    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-12 items-center">
          <div className="lg:col-span-1 border-r border-gray-200 pr-12 hidden lg:block">
            <div className="space-y-12">
              {[
                {
                  label: "Total Fleet Bounty",
                  val: formatBounty(
                    allPirates.reduce((a, b) => a + b.bounty, 0),
                  ),
                  icon: Skull,
                },
                {
                  label: "High Risk Targets",
                  val: allPirates.length,
                  icon: Shield,
                },
                {
                  label: "Sea Locations",
                  val: islandDanger.length,
                  icon: GlobeIcon,
                },
              ].map((stat, i) => (
      ...
      <section id="global-threats" className="py-32 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none hidden xl:block">
          <WantedPosterSkeleton
            pirate={randomDecorPirates[0]}
            className="absolute top-20 -left-12 opacity-20 rotate-6"
          />
          <WantedPosterSkeleton
            pirate={randomDecorPirates[1]}
            className="absolute top-1/2 -right-12 opacity-20 -rotate-6"
          />
          <WantedPosterSkeleton
            pirate={randomDecorPirates[2]}
            className="absolute bottom-20 -left-12 opacity-20 rotate-12"
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            ...
            <div>
              <SectionHeader
                id="crews"
                badge="Syndicates"
                title="Dangerous Crews"
                subtitle="Aggregated bounty totals from World Government records."
              />
              <div className="space-y-4">
                {crewStats.slice(0, 6).map((c, i) => (
                  <div
                    key={c.tripulacao}
                    className="flex items-center justify-between p-6 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md transition-all group"
                  >
                    <div className="flex items-center gap-5">
                      <div className="text-2xl font-black text-gray-200 tracking-tighter w-8">
                        0{i + 1}
                      </div>
                      <div className="font-black text-gray-900 group-hover:text-[#001C5E] transition-colors">
                        {c.tripulacao}
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-lg font-black text-[#001C5E]">
                        {formatBounty(c.bounty)}
                      </div>
            ...
            <div>
              <SectionHeader
                id="commanders"
                badge="Commanders"
                title="Commanders of Threat"
                subtitle="Rankings based on individual and collective risk factors."
              />
                ...
                {captainStats.slice(0, 6).map((cap, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        onClick={() =>
                          setExpandedCommander(isExpanded ? null : cap.capitao)
                        }
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-end mb-1">
                            <div className="flex items-center gap-2">
                              ...
                              <ChevronRight
                                className={`w-4 h-4 text-gray-300 transition-transform duration-300 ${isExpanded ? "rotate-90" : ""}`}
                              />
                            </div>
                            <span className="text-sm font-black text-[#98D7C2]">
                              {formatBounty(cap.bounty)}
                            </span>
                          </div>
                          <div className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                            <div
                              className="h-full bg-[#001C5E] transition-all duration-1000"
                              style={{
                                width:
                                  cap.bounty > 0
                                    ? `${(cap.bounty / captainStats[0].bounty) * 100}%`
                                    : "0%",
                              }}
                            />
                          </div>
                          ...
                          >
                            <div className="px-6 pb-6 pt-2 space-y-3">
                              <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1">
                                Subordinated Intelligence
                              </div>
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {crew.map((member) => {
                                  const isCaptain =
                                    member.pirata === cap.capitao;
                                  return (
                                    <div
                                      key={member.pirata}
                                      onClick={(e) => {
                                        e.stopPropagation();
                                        setSelectedPirate(member);
                                      }}
                                    ...
                                    >
                                      <div className="flex items-center gap-3 overflow-hidden">
                                        <Skull
                                          className={`w-3 h-3 flex-shrink-0 ${isCaptain ? "text-[#98D7C2]" : "text-gray-300"}`}
                                        />
                                        <span
                                          className={`text-xs font-bold truncate ${isCaptain ? "text-white" : "text-gray-700"}`}
                                        >
                                          {member.pirata}
                                          {isCaptain && (
                                      ...
                                      <span
                                        className={`text-[10px] font-mono font-black ${isCaptain ? "text-[#98D7C2]" : "text-[#0039B9]"}`}
                                      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center font-sans">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-xl text-gray-500 max-w-xl leading-relaxed font-medium">
                The Marine HQ calls upon those with the courage to uphold the
                honor of the seas. Rise through the ranks, protect the innocent,
                and serve with unwavering pride.
              </p>
            </div>
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-24 relative z-10">
          <div className="lg:col-span-1 border-r border-gray-100 pr-12">
            ...
            <h2 className="text-5xl font-black mb-8 tracking-tighter leading-tight text-gray-900">
              Island <br /> <span className="text-[#001C5E]">Threat Index</span>
            </h2>
            <p className="text-gray-500 text-lg mb-12">
              Real-time geospatial intelligence and territory evaluation.
            </p>
              ...
              {islandDanger.slice(0, 8).map((island, i) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`h-2 w-2 rounded-full ${i < 3 ? "bg-red-500 animate-pulse" : "bg-gray-200"}`}
                    />
                    <div className="font-black text-xl text-gray-900 group-hover:text-[#001C5E] transition-colors">
                      {island.ilha}
                    </div>
                  </div>
                  <div className="text-[#001C5E] font-black font-mono">
                    {formatBounty(island.bounty)}
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 p-10 rounded-[3rem] border border-gray-200 relative overflow-hidden group hover:border-[#98D7C2] hover:shadow-xl transition-all">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="font-black text-2xl uppercase tracking-tight text-gray-900">
                  Yonko Priority
                </h3>
              </div>
              <div className="space-y-4">
                {yonkoTargets.map((y) => (
                  ...
                  >
                    ...
                    <span className="text-[#001C5E] font-black text-sm font-mono">
                      {formatBounty(y.bounty)}
                    </span>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gray-50 p-10 rounded-[3rem] border border-gray-200 relative overflow-hidden group hover:border-[#98D7C2] hover:shadow-xl transition-all">
              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <div className="text-2xl font-black text-[#001C5E] font-mono">
                    {formatBounty(warlords.variance / 1e9)}B
                  </div>
                </div>
              </div>
              <div className="space-y-4 overflow-y-auto max-h-64 pr-2 custom-scrollbar">
                {warlords.data.map((w) => (
                  ...
                  >
                    ...
                    <span className="text-[#001C5E] font-black text-xs font-mono">
                      {formatBounty(w.bounty)}
                    </span>
                  </div>
                ))}
              </div>
      ...
      <section id="bounty-feed" className="py-32 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            ...
            >
              <Search
                className={`w-4 h-4 transition-transform duration-300 ${isFeedExpanded ? "rotate-90" : ""}`}
              />
              {isFeedExpanded
              ...
              >
                ...
                <div className="mb-10 flex flex-col md:flex-row gap-6 items-center justify-between">
                  ...
                  <div className="flex gap-2 p-1.5 bg-gray-50 rounded-2xl border border-gray-100">
                    {["All", "Vivo", "Falecido", "Desaparecido"].map(
                      (status) => (
                        <button
                          key={status}
                  ...
                  <table className="w-full text-left border-collapse bg-white">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-100">
                        <th className="py-6 px-10 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                          Name
                        </th>
                        <th className="py-6 px-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                          Status / Location
                        </th>
                        <th className="py-6 px-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                          Crew
                        </th>
                        <th className="py-6 px-4 text-[10px] font-black text-gray-400 uppercase tracking-widest text-right">
                          Bounty
                        </th>
                      </tr>
                    </thead>
                      ...
                      {filteredPirates.map((p, i) => (
                        ...
                        >
                          <td className="py-8 px-10">
                            <span className="font-black text-gray-900 group-hover:text-[#001C5E] transition-colors text-lg">
                              {p.pirata}
                            </span>
                          </td>
                          <td className="py-8 px-4">
                            <div className="flex flex-col">
                              <span
                                className={`text-[10px] font-black uppercase tracking-widest mb-1 ${p.status_historia === "Falecido" ? "text-red-500" : "text-green-500"}`}
                              >
                                {p.status_historia}
                              </span>
                          ...
                          <td className="py-8 px-4 font-bold text-gray-600 text-sm">
                            {p.tripulacao}
                          </td>
                          <td className="py-8 px-10 text-right">
                            <div className="text-xl font-black text-gray-900 group-hover:text-[#001C5E] transition-colors">
              ...
              >
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-3/5 p-12 relative">
                    ...
                    <div className="text-[#001C5E] text-[10px] font-black uppercase tracking-[0.3em] mb-4">
                      Subject Personnel File
                    </div>
                    <h2 className="text-5xl font-black text-gray-900 mb-6 tracking-tighter uppercase">
                      {selectedPirate.pirata}
                    </h2>
                    ...
                    <div className="grid grid-cols-2 gap-8 mb-10">
                      <div>
                        ...
                        <div className="text-2xl font-black text-[#001C5E] font-mono">
                          {formatBounty(selectedPirate.bounty)}
                        </div>
                      </div>
                      <div>
                        <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">
                    ...
                    <div className="space-y-6">
                      <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                        <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                          <Shield className="w-3 h-3 text-[#001C5E]" />{" "}
                          Intelligence Appraisal
                        </div>
                        <p className="text-gray-600 leading-relaxed font-medium italic">
                          {selectedPirate.observacoes ||
                            "No field notes available for this individual. Caution is advised during engagement."}
                        </p>
                      </div>
                      <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2">
                          <div
                            className={`w-2 h-2 rounded-full ${selectedPirate.status_historia === "Falecido" ? "bg-red-500" : "bg-green-500"}`}
                          />
                          <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">
                            {selectedPirate.status_historia}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
...
const OperationsCenter = () => {
  ...
  const handleIslandSelect = (island: any) => {
    ...
    if (globeEl.current) {
      globeEl.current.pointOfView(
        { lat: island.lat, lng: island.lng, altitude: 2 },
        1000,
      );
    }
  };
  ...
  const modules = [
    {
      id: "total-bounty",
      label: "Bounty per Crew",
      icon: Users,
      data: DataService.getBountyByCrew(),
    },
    {
      id: "avg-bounty",
      label: "Average Bounty",
      icon: Activity,
      data: DataService.getAverageBounty(),
    },
    {
      id: "dangerous-captains",
      label: "Dangerous Captains",
      icon: Skull,
      data: DataService.getDangerousCaptains(),
    },
    {
      id: "top-3",
      label: "Top 3 Pirates",
      icon: Zap,
      data: DataService.getTop3Pirates(),
    },
    {
      id: "island-threat",
      label: "Island Threat Index",
      icon: GlobeIcon,
      data: DataService.getDangerByIsland(),
    },
    {
      id: "emperors",
      label: "Yonko",
      icon: Shield,
      data: DataService.getYonko(),
    },
    {
      id: "shichibukai",
      label: "Ex-Shichibukai",
      icon: Anchor,
      data: {
        list: DataService.getExShichibukai(),
        stats: DataService.getExShichibukaiStats(),
      },
    },
    {
      id: "dead-targets",
      label: "Dead Targets",
      icon: AlertCircle,
      data: DataService.getDeadPirates(),
    },
    {
      id: "combined-ranking",
      label: "Combined Ranking",
      icon: Radar,
      data: DataService.getCombinedThreatRanking(),
    },
  ];
  ...
  return (
    <section
      id="operations"
      className="py-32 bg-white text-gray-900 relative overflow-hidden border-t border-gray-100"
    >
      {/* Decorative Posters */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.15] hidden lg:block overflow-hidden">
        <WantedPosterSkeleton
          pirate={randomDecorPirates[0]}
          className="absolute top-[10%] -left-16 -rotate-12 blur-[1px]"
        />
        <WantedPosterSkeleton
          pirate={randomDecorPirates[1]}
          className="absolute bottom-[15%] -left-12 rotate-6 blur-[2px]"
        />
        <WantedPosterSkeleton
          pirate={randomDecorPirates[2]}
          className="absolute top-[20%] -right-16 rotate-12 blur-[1px]"
        />
        <WantedPosterSkeleton
          pirate={randomDecorPirates[3]}
          className="absolute bottom-[25%] -right-12 -rotate-12 blur-[2px]"
        />
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/3">
            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-200 shadow-sm transition-all hover:shadow-md">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <h2 className="text-xl font-black tracking-tight uppercase text-[#0039B9]">
                    Command Panel
                  </h2>
                  <p className="text-xs text-gray-400 font-medium">
                    Select Intelligence Analysis Module
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                {modules.map((mod) => (
                  ...
                  >
                    <mod.icon
                      className={`w-4 h-4 transition-colors ${activeModule === mod.id ? "text-[#0039B9]" : "text-gray-400 group-hover:text-[#0039B9]"}`}
                    />
                    {mod.label}
                  </button>
                ))}
          ...
          <div className="lg:w-2/3 h-[600px] bg-gray-50 rounded-3xl p-8 border border-gray-200 overflow-y-auto custom-scrollbar shadow-sm">
            <div className="flex items-center justify-between mb-8 border-b border-gray-200 pb-6">
              <div>
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#0039B9] mb-1 block">
                  Sector Synchronization
                </span>
                <h3 className="text-2xl font-black tracking-tight text-gray-900">
                  {currentModule.label} Analysis
                </h3>
              </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col h-full space-y-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {(currentModule.data as any[]).map((item, i) => (
                      <div
                        key={i}
                        className="flex items-center justify-between bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:border-[#98D7C2] transition-colors"
                      >
                        <div className="flex items-center gap-4">
                        ...
                        <span className="font-mono text-[#0039B9] font-black">
                  ...
                  <div className="pt-8 border-t border-gray-100 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-full text-[10px] font-black uppercase tracking-widest text-gray-400">
                      <Activity className="w-3 h-3" /> Interact with segments
                      for deep intel
                    </div>
                  </div>
                </div>
              ...
              {currentModule.id === "avg-bounty" && (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <div className="text-7xl font-black text-[#0039B9] tracking-tighter mb-4">
                    {formatBounty(currentModule.data as number)}
                  </div>
                  <p className="text-sm text-gray-500 max-w-xs mx-auto italic font-medium">
                    Average threat level calculated across all registered
                    targets.
                  </p>
                </div>
              )}

              {currentModule.id === "dangerous-captains" &&
                (currentModule.data as any[]).map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:border-[#98D7C2] transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {(currentModule.data as PirateRecord[]).map((p) => {
                    ...
                    return (
                      <div
                        key={p.pirata}
                        className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm text-center group hover:border-[#98D7C2]/50 hover:shadow-md transition-all"
                      >
                        ...
                        <div className="text-sm font-black uppercase truncate text-gray-900">
                          {p.pirata}
                        </div>
                        <div className="text-xs text-[#0039B9] font-mono mt-1 font-bold">
                          {formatBounty(p.bounty)}
                        </div>
                      </div>
                    );
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="w-full h-[400px] bg-[#001C5E] rounded-[2.5rem] overflow-hidden relative shadow-inner border border-gray-200">
                    <Globe
                      ...
                      pointLng="lng"
                      pointColor={(d: any) =>
                        d.ilha === selectedIsland ? "#facc15" : d.color
                      }
                      pointAltitude={(d: any) =>
                        d.ilha === selectedIsland ? 0.3 : 0.1
                      }
                      pointRadius={(d: any) =>
                        d.ilha === selectedIsland ? 1.2 : 0.6
                      }
                      pointsMerge={false}
                      onPointClick={(point: any) => handleIslandSelect(point)}
                      onGlobeClick={() => {
                        const randomIndex = Math.floor(
                          Math.random() * islandsData.length,
                        );
                    ...
                    <div className="absolute bottom-6 left-6 pointer-events-none">
                      <div className="bg-black/40 backdrop-blur-md px-4 py-2 rounded-xl border border-white/10">
                        <div className="text-[8px] font-black uppercase tracking-[0.2em] text-[#98D7C2] mb-1">
                          Geospatial Awareness
                        </div>
                        <div className="text-white text-sm font-bold">
                          {selectedIsland || "Scan Sector Protocol"}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {(currentModule.data as any[]).map((item, i) => {
                      const islandMapData = islandsData.find(
                        (id) => id.ilha === item.ilha,
                      );
                      ...
                      return (
                        <div
                          key={i}
                          onClick={() =>
                            islandMapData && handleIslandSelect(islandMapData)
                          }
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div
                              className={`p-2 rounded-lg transition-colors ${isSelected ? "bg-[#0039B9] text-white" : "bg-[#0039B9]/5 text-[#0039B9]"}`}
                            >
                              <GlobeIcon className="w-4 h-4" />
                            </div>
                            <span
                              className={`font-bold transition-colors ${isSelected ? "text-[#0039B9]" : "text-gray-800"}`}
                            >
                              {item.ilha}
                            </span>
                          </div>
                          <div className="flex items-center gap-4">
                            <div className="w-24 h-1.5 bg-gray-100 rounded-full overflow-hidden hidden sm:block">
                              <div
                                ...
                                style={{
                                  width: `${Math.min(100, (item.bounty / 10000000000) * 100)}%`,
                                }}
                              />
                            </div>
                            <span
                              className={`font-mono text-xs font-black w-24 text-right transition-colors ${isSelected ? "text-[#0039B9]" : "text-gray-400"}`}
                            >
                              {formatBounty(item.bounty)}
                            </span>
                          </div>
                ...
                <div className="space-y-4">
                  {(currentModule.data as PirateRecord[]).map((p, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="font-mono text-sm text-[#0039B9] font-black">
                          {formatBounty(p.bounty)}
                        </span>
                      </div>
                    );
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-200/50">
                    <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-4 px-2 flex items-center gap-2">
                      <Shield className="w-3 h-3 text-[#0039B9]" /> Classified
                      Record: Marineford Legacy
                    </div>
                    <div className="relative w-full aspect-[21/9] rounded-[2rem] overflow-hidden shadow-xl group cursor-help">
                      ...
                      <div className="absolute inset-0 z-10 p-8 flex flex-col justify-center">
                        <div className="text-[#98D7C2] text-[8px] font-black uppercase tracking-[0.4em] mb-2">
                          Internal Intel Archive
                        </div>
                        <h4 className="text-white text-2xl font-black uppercase tracking-tighter leading-none mb-3">
                          The Yonko <br /> Great War Era
                        </h4>
                        <div className="flex items-center gap-4">
                          <div className="h-0.5 w-12 bg-[#98D7C2]/50 rounded-full" />
                          <p className="text-white/60 text-[10px] font-bold tracking-tight">
                            Accessing Declassified Reports...
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                      ...
                      <div className="text-xl font-black text-[#0039B9]">
                        {formatBounty((currentModule.data as any).stats.avg)}
                      </div>
                    </div>
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                      <div className="text-[10px] font-black uppercase text-gray-400 mb-1">
                      ...
                      <div className="text-xl font-black text-[#0039B9]">
                        {Math.sqrt(
                          (currentModule.data as any).stats.variance,
                        ).toFixed(2)}
                      </div>
                    </div>
                  </div>
                  {(currentModule.data as any).list.map(
                    (p: PirateRecord, i: number) => (
                      <div
                        key={i}
                        className="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-50 shadow-sm"
                      >
              ...
              {currentModule.id === "dead-targets" &&
                (currentModule.data as PirateRecord[]).map((p, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between bg-red-50/50 p-4 rounded-xl border border-red-100 opacity-80 grayscale"
                  >
                    <div className="flex items-center gap-4">
                      <Skull className="w-4 h-4 text-red-500" />
                      <span className="font-bold text-gray-600 underline decoration-red-200 decoration-2">
                        {p.pirata}
                      </span>
                    </div>
                    <div className="text-right">
                      <div className="text-[10px] font-black uppercase text-red-500 mb-0.5">
                        Eliminated
                      </div>
              ...
              {currentModule.id === "combined-ranking" &&
                (currentModule.data as PirateRecord[]).map((p, i) => (
                  <div
                    key={p.pirata}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        className={`text-sm font-bold ${p.status_historia === "Falecido" ? "text-gray-300 line-through" : "text-gray-800"}`}
                      >
                        {p.pirata}
                      </span>
                    </div>
        ...
        <div className="grid grid-cols-8 gap-20 rotate-12 -translate-x-1/4 -translate-y-1/4 scale-150">
          {Array.from({ length: 64 }).map((_, i) => (
            <div key={i} className="flex justify-center">
              <Logo className="w-20 h-20" fill="#0039B9" />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="bg-[#0039B9] rounded-[4rem] px-10 py-32 md:p-32 text-center relative overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,57,185,0.4)]">
          ...
          <p className="text-white/70 text-xl md:text-2xl mb-16 max-w-2xl mx-auto font-medium leading-relaxed relative z-10">
            Join the elite command of the World Government. Secure your
            territory and neutralize every threat to world peace with authorized
            Marine assets.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-20 mb-20">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-6 mb-8 group">
              ...
              <div>
                <span className="font-black text-3xl text-gray-900 tracking-tighter leading-none block">
                  MARINE HQ
                </span>
                <span className="text-[10px] text-gray-400 font-black uppercase tracking-[0.4em] mt-1.5 block leading-none">
                  Global Defense Command
                </span>
              </div>
            </div>
            <p className="text-gray-500 max-w-sm text-xl leading-relaxed mb-10">
              Strategizing peace through absolute command. The primary military
              force for the World Government across the Grand Line.
            </p>
          </div>
          <div>
            <h5 className="font-black text-gray-900 uppercase tracking-[0.2em] text-xs mb-10">
              Intelligence
            </h5>
            <ul className="space-y-5">
              {[
                ...
                <li key={item}>
                  <a
                    href="#"
                    className="text-gray-500 font-bold hover:text-[#98D7C2] transition-colors"
                  >
                    {item}
                  </a>
                </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-16 border-t border-gray-100">
          <div className="text-gray-400 text-[10px] font-black uppercase tracking-[0.5em]">
            ...
            ALL RIGHTS TO ONE PIECE, ITS CHARACTERS, STORY, AND UNIVERSE BELONG
            TO TOEI ANIMATION AND EIICHIRO ODA.
          </div>
          <div className="flex items-center gap-10">
            <a
              href="#"
              className="text-[10px] font-black text-gray-500 hover:text-[#98D7C2] transition-colors uppercase tracking-[0.2em]"
            >
              Privacy Protocol
            </a>
            <a
...
export default function App() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(160deg, #ffffff 0%, #f0f7ff 40%, #e8fdf5 100%)",
      }}
    >
      <Navbar />
      ...
      <main className="relative flex flex-col items-center justify-start px-6 pt-52 text-center min-h-[90vh] overflow-hidden">
        ...
        <div className="absolute inset-0 z-[15] pointer-events-none overflow-hidden hidden lg:block">
          {/* Left Side */}
          <WantedPosterSkeleton
            pirate={headerPirates[0]}
            className="absolute top-[10%] -left-10 opacity-40 rotate-12 blur-[1px]"
          />
          <WantedPosterSkeleton
            pirate={headerPirates[1]}
            className="absolute top-[40%] left-20 opacity-60 rotate-6"
          />
          <WantedPosterSkeleton
            pirate={headerPirates[2]}
            className="absolute top-[70%] -left-5 opacity-30 rotate-[45deg] blur-[2px]"
          />

          {/* Right Side */}
          <WantedPosterSkeleton
            pirate={headerPirates[3]}
            className="absolute top-[15%] -right-12 opacity-50 -rotate-12 blur-[1px]"
          />
          <WantedPosterSkeleton
            pirate={headerPirates[4]}
            className="absolute top-[50%] right-16 opacity-70 -rotate-3"
          />
          <WantedPosterSkeleton
            pirate={headerPirates[5]}
            className="absolute top-[80%] -right-8 opacity-40 -rotate-[45deg] blur-[2px]"
          />
        </div>
        ...
        <div className="relative z-20 flex flex-col items-center">
          <h1 className="animate-float-up text-[4rem] md:text-[5.5rem] leading-[0.9] tracking-tight font-black text-[#050A1A] max-w-4xl px-4">
            <span className="text-black">正義</span>
            <br />
            <span className="text-[#00ac71]">Justice.</span>
            <br />
            <span className="text-[#00ac71]">Justice </span>
            <span className="text-[#0039B9]">Will</span>
            <span className="text-[#00ac71]"> Prevail.</span>
          </h1>
          <p className="animate-float-up-delay-1 mt-8 text-lg md:text-xl text-gray-500 max-w-2xl leading-relaxed">
            Consuming strategic surveillance from the Global Marine Data
            repository.
          </p>
        </div>
      </main>
